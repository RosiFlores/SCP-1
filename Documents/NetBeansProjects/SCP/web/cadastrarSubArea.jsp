            ...
            <div>
                <table>
                    <tr>
                        ...
                        <td>
                            <input type="text" name="codigoSubArea" value="${subArea.codigoSubArea}" <c:if test="${operacao != 'Incluir'}"> readonly</c:if>><br><br>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="text" name="nomeSubArea" value="${subArea.nomeSubArea}" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>><br><br>
                        </td>
                    </tr> 
                </table><br/><br/>
